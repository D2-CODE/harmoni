        ...
        <div className='card-section2'>
            <div className='card container' style={{ borderRadius: 0, overflow: 'hidden', margin: 0, display: 'flex', justifyContent: 'left' }
                ...
                <div className='card-body' style={{ justifyContent: 'left', alignItems: 'start' }}>
                    <div className='card-title' style={{ height: '40px', padding: '10px', width: '45%', textAlign: 'left', display: 'flex', justifyContent: 'left' }}>
                    ...
                    <div className='card-title' style={{ height: '40px', padding: '10px', width: '45%', textAlign: 'left' }}>
